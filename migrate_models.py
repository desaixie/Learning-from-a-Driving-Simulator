...
#     return module
# solving bug https://discuss.pytorch.org/t/batchnorm2d-object-has-no-attribute-track-running-stats/17525/16
# for i, (name, module) in enumerate(prior._modules.items()):
#     module = recursion_change_bn(prior)
...
# for i, (name, module) in enumerate(pose_network._modules.items()):
#     module = recursion_change_bn(pose_network)
# for i, (name, module) in enumerate(conv_network._modules.items()):
#     module = recursion_change_bn(conv_network)
#
# saved_model['prior'] = pr_new
# saved_model['encoder'] = e_new
# saved_model['decoder'] = d_new
# saved_model['pose_network'] = po_new
# saved_model['conv_network'] = c_new
